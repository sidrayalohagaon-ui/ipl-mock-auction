...
const franchisesData = [
  { id: "CSK", name: "Chennai Super Kings", shortName: "CSK", owner: "India Cements", color: "#f8d107", secondaryColor: "#005ea6", budget: 43.40, squad: [], rtmCards: 3, venue: "M. A. Chidambaram Stadium, Chennai", preferences: { Batsman: 1.1, Bowler: 1.0, Wicketkeeper: 1.2, "All-Rounder": 1.3, maxRatingWeight: 0.95 } },
  { id: "MI", name: "Mumbai Indians", shortName: "MI", owner: "Reliance Industries", color: "#004ba0", secondaryColor: "#d1ab3a", budget: 2.75, squad: [], rtmCards: 3, venue: "Wankhede Stadium, Mumbai", preferences: { Batsman: 1.2, Bowler: 1.3, Wicketkeeper: 1.0, "All-Rounder": 1.1, maxRatingWeight: 0.98 } },
  { id: "RCB", name: "Royal Challengers Bengaluru", shortName: "RCB", owner: "Diageo", color: "#ec1c24", secondaryColor: "#000000", budget: 16.40, squad: [], rtmCards: 3, venue: "M. Chinnaswamy Stadium, Bengaluru", preferences: { Batsman: 1.4, Bowler: 1.1, Wicketkeeper: 1.1, "All-Rounder": 1.0, maxRatingWeight: 0.96 } },
  { id: "KKR", name: "Kolkata Knight Riders", shortName: "KKR", owner: "Red Chillies Entertainment", color: "#3a225d", secondaryColor: "#f1c40f", budget: 64.30, squad: [], rtmCards: 3, venue: "Eden Gardens, Kolkata", preferences: { Batsman: 1.0, Bowler: 1.1, Wicketkeeper: 1.0, "All-Rounder": 1.4, maxRatingWeight: 0.93 } },
  { id: "RR", name: "Rajasthan Royals", shortName: "RR", owner: "Emerging Media", color: "#ea1a85", secondaryColor: "#254aa5", budget: 16.05, squad: [], rtmCards: 3, venue: "Sawai Mansingh Stadium, Jaipur", preferences: { Batsman: 1.2, Bowler: 1.2, Wicketkeeper: 1.1, "All-Rounder": 1.0, maxRatingWeight: 0.94 } },
  { id: "DC", name: "Delhi Capitals", shortName: "DC", owner: "GMR & JSW", color: "#1b3e85", secondaryColor: "#ef4123", budget: 21.80, squad: [], rtmCards: 3, venue: "Arun Jaitley Stadium, Delhi", preferences: { Batsman: 1.1, Bowler: 1.2, Wicketkeeper: 1.3, "All-Rounder": 1.0, maxRatingWeight: 0.91 } },
  { id: "SRH", name: "Sunrisers Hyderabad", shortName: "SRH", owner: "SUN Group", color: "#f26522", secondaryColor: "#000000", budget: 25.50, squad: [], rtmCards: 3, venue: "Rajiv Gandhi International Cricket Stadium, Hyderabad", preferences: { Batsman: 1.3, Bowler: 1.2, Wicketkeeper: 1.0, "All-Rounder": 1.1, maxRatingWeight: 0.92 } },
  { id: "PBKS", name: "Punjab Kings", shortName: "PBKS", owner: "KPH Dream Cricket", color: "#ed1f24", secondaryColor: "#ffffff", budget: 11.50, squad: [], rtmCards: 3, venue: "Inderjit Singh Bindra Stadium, Mohali", preferences: { Batsman: 1.1, Bowler: 1.2, Wicketkeeper: 1.1, "All-Rounder": 1.2, maxRatingWeight: 0.89 } },
  { id: "LSG", name: "Lucknow Super Giants", shortName: "LSG", owner: "RPSG Group", color: "#1f4a7c", secondaryColor: "#e6ad1c", budget: 22.95, squad: [], rtmCards: 3, venue: "Ekana Cricket Stadium, Lucknow", preferences: { Batsman: 1.1, Bowler: 1.1, Wicketkeeper: 1.2, "All-Rounder": 1.3, maxRatingWeight: 0.90 } },
  { id: "GT", name: "Gujarat Titans", shortName: "GT", owner: "CVC Capital", color: "#1b253b", secondaryColor: "#cca355", budget: 12.90, squad: [], rtmCards: 3, venue: "Narendra Modi Stadium, Ahmedabad", preferences: { Batsman: 1.2, Bowler: 1.3, Wicketkeeper: 1.0, "All-Rounder": 1.1, maxRatingWeight: 0.91 } }
];
